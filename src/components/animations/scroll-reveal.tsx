...
export function ScrollReveal({
  ...
  // Fade in/out near edges (faster reveal for scroll responsiveness)
  // 0-0.08: Fade in at bottom edge
  // 0.08-0.92: Fully visible
  // 0.92-1.0: Fade out at top edge
  ...
  const y = useTransform(scrollYProgress, [0, 0.08, 0.92, 1], yValues);
